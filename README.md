...
Built on **Fedora 43** and includes: Node.js, npm, Python 3, pip, Git, curl, wget, ripgrep, fd-find, jq, yq, tree, Ansible, strace, and standard GNU utilities (sed, gawk, grep, findutils, diffutils, patch, tar, gzip, unzip).
